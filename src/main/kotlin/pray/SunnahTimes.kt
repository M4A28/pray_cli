...
class SunnahTimes(prayerTimes: PrayerTimes) {
    ...
    init {
        ...
        val nightDurationInSeconds = ((tomorrowPrayerTimes.fajr!!.time - prayerTimes.maghrib!!.time) / 1000).toInt()
        middleOfTheNight = CalendarUtil.roundedMinute(
            CalendarUtil.add(prayerTimes.maghrib, (nightDurationInSeconds / 2.0).toInt(), Calendar.SECOND)
        )
