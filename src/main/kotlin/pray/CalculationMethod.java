...
public enum CalculationMethod {
    ...
    /**
     * Return the pray.CalculationParameters for the given method
     *
     * @return pray.CalculationParameters for the given Calculation method
     */
    public CalculationParameters getParameters() {
        switch (this) {
            ...
            default -> {
                throw new IllegalArgumentException("Invalid pray.CalculationMethod");
            }
        }
    }
}
